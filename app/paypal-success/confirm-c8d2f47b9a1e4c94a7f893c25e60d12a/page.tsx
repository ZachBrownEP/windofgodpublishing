...
const WorshipWriteWarConfirmPage = () => {
  const searchParams = useSearchParams()
  const [copiedLink, setCopiedLink] = useState(false)
  const [copiedMeetingId, setCopiedMeetingId] = useState(false)
  const [copiedPasscode, setCopiedPasscode] = useState(false)

  // Zoom access details for Worship, Write, and War event
  const ZOOM_LINK = "https://us02web.zoom.us/j/89589931125?pwd=62lwRxKkN6QB5nYqUTQ0NhbeEwlaSa.1"
  const MEETING_ID = "895 8993 1125"
  const ZOOM_PASSCODE = "858006"
          ...
          <Card className="mb-8 rounded-t-none border-t-0">
            <CardContent className="p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">Join your live writing encounter using the details below</p>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Button
                        onClick={() => copyToClipboard(MEETING_ID, "meetingId")}
                        variant="outline"
                        size="sm"
                        className="flex-shrink-0"
                      >
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <ul className="mt-2 text-sm text-yellow-700 space-y-1">
                      <li>• Save these access details - you'll need them to join the live event</li>
              ...
              <CardContent className="p-6">
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono text-sm">#7XHXQ19</span>
                  </div>
                  <div className="flex justify-between">
          ...
          <Card className="mb-8">
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                <Image
                  src="/images/worship-write-war.png"
                  alt="Worship, Write, and War: A 2-Hour Writing Encounter"
                  width={80}
                  height={80}
...
export default WorshipWriteWarConfirmPage
